 ...
 */
final class Version20211217064931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE product SET uuid=uuid_generate_v4() WHERE uuid is NULL'); //только для POSTGRESQL
    }
